    ...
    <div className="animate-scale-in w-full overflow-hidden rounded-xs border border-white/[0.06] bg-white/[0.02] backdrop-blur-sm custom-scroll">
      ...
      <div className="hidden md:flex md:flex-col">
        <div className="grid grid-cols-[200px_1fr_180px] gap-x-4 border-b border-white/[0.06] px-5 py-4">
          <span className="text-[10px] font-semibold uppercase tracking-widest text-white/30">Clase</span>
          <span className="text-[10px] font-semibold uppercase tracking-widest text-white/30">Actividad</span>
          <span className="text-right text-[10px] font-semibold uppercase tracking-widest text-white/30">Entrega</span>
        </div>
            ...
            return (
              ...
              >
                <div className="flex items-center">
                  <span className={`inline-block rounded-xs border px-2.5 py-0.5 text-[11px] font-bold leading-5 ${badgeColor(t.clase)}`}>
                    {t.clase}
                  </span>
                </div>
                <div className="flex items-center">
                ...
                <div className="flex flex-col items-end justify-center whitespace-nowrap">
                  <span className="text-[11px] font-semibold capitalize text-white/70">{formatFecha(fecha)}</span>
                  <span className="mt-0.5 font-mono text-xs font-bold text-indigo-400/70">{formatHora(fecha)}</span>
                  {dias <= 2 && dias >= 0 && (
